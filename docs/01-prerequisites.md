...
If you have an M-series (Apple Silicon) Mac OR ARM64 Windows Machine, you cannot run VirtualBox. Please instead see our [Apple Silicon](../../apple-silicon/) guide.
...
This lab was last tested with VirtualBox 7.2.6, though newer versions should be ok.
...
This lab was last tested with Vagrant 2.4.9, though newer versions should be ok.
...
The VirtualBox/Vagrant has been pre-configured for quick lab set up and does not require addiitonal steps to have a running lab ready for kubernetes lab work. There are details below with more information about the lab's Configuration.
